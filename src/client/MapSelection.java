...
public class MapSelection {
	...
	public static int display() {
		...
		ImageView map1 = new ImageView(new Image(FileSettings.assets + "/Map1.png"));
		...
		ImageView map2 = new ImageView(new Image(FileSettings.assets + "/Map2.png"));
		...
		ImageView map3 = new ImageView(new Image(FileSettings.assets + "/Map3.png"));
		...
		ImageView map4 = new ImageView(new Image(FileSettings.assets + "/Map4.png"));
		...
		ImageView map5 = new ImageView(new Image(FileSettings.assets + "/BasicTestMap.png"));
		...
		ImageView map6 = new ImageView(new Image(FileSettings.assets + "/BasicTestMap.png"));
		...
		ImageView map7 = new ImageView(new Image(FileSettings.assets + "/BasicTestMap.png"));
		...
		ImageView map8 = new ImageView(new Image(FileSettings.assets + "/BasicTestMap.png"));
